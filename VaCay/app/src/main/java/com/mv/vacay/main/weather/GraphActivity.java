...
public class GraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title=(TextView)findViewById(R.id.temperature);
    ...
    public ParseResult parseLongTermJson(String result) {
        ...
        try {
            ...
            for (i = 0; i < list.length(); i++) {
                ...
                if (rainObj != null) {
                    weather.setRain(MmainActivity.getRainString(rainObj));
                } else {
                    weather.setRain(MmainActivity.getRainString(snowObj));
                }
