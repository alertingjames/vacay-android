...
//                intent.putExtra("first name",user.get_firstName());
//                intent.putExtra("last name",user.get_lastName());
//                intent.putExtra("photo",user.get_imageRes());
//                intent.putExtra("city",user.get_city());
//                intent.putExtra("job",user.get_job());
//                intent.putExtra("education",user.get_education());
//                intent.putExtra("interest",user.get_interest());
//                intent.putExtra("age range",user.get_age_range());
