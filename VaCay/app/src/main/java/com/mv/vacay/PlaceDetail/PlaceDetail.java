...
import com.mv.vacay.Utility.PlaceDetailParser;
import com.mv.vacay.nearby.ErrorFragment;
import com.mv.vacay.nearby.PagerAnimation;
import com.mv.vacay.nearby.Search;
import com.mv.vacay.nearby.SlidingTabLayout;
    ...
    public void onFetchCompletion(String string, int id) {
        ...
        if(string == null || string.equals("")){
            ...
            try {
                ...
                fragAbout.setArguments(data);   Log.d("AAAAA===>", String.valueOf(detailBean.getLat()));
