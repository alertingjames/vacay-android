...
import com.mv.vacay.main.provider.CalendarActivity;
...
public class ProviderDateTimeListAdapter extends BaseAdapter {

    private CalendarActivity _context;
    ...
    public ProviderDateTimeListAdapter(CalendarActivity context){
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Commons._datetimeId=position;
                _context.showChoiceDialog();
            }
        });
