 ...
 */
@TargetApi(13)
public final class VideoPlayListActivity extends Activity implements OnFullscreenListener {
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        static {
            ...
            for(int i = 0; i< Commons.gameEntitiesAll.size(); i++){
                list.add(new VideoEntry(Commons.gameEntitiesAll.get(i).getGameName(), Commons.gameEntitiesAll.get(i).getVideoId()));
            }
...
//            VIDEO_LIST = Collections.unmodifiableList(list);
    ...
    private static final class PageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                thumbnail.initialize(Config.API_KEY, thumbnailListener);
            } else {
                YouTubeThumbnailView thumbnail = (YouTubeThumbnailView) view.findViewById(R.id.thumbnail);
    ...
    public static final class VideoFragment extends YouTubePlayerFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            initialize(Config.API_KEY, this);
        }
        ...
        public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean restored) {
            ...
            player.setOnFullscreenListener((VideoPlayListActivity) getActivity());
