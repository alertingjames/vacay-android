...
public class NewYorkRestaurantMenuActivity extends BaseActivity implements View.OnClickListener,SwipyRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_york_restaurant_menu);
...
//        }
        ...
        String[] opentables= new String[]{getString(R.string.opa), getString(R.string.opb), getString(R.string.opd), getString(R.string.opg), getString(R.string.oph), getString(R.string.ophh), getString(R.string.opl), getString(R.string.opn), getString(R.string.ops),getString(R.string.opss), getString(R.string.opt), getString(R.string.optt)};
