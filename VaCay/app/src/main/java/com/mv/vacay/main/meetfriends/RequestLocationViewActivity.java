...
public class RequestLocationViewActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_location_view);
...
//                break;
    ...
    private void requestLocationView() {
        ...
        LatLng loc=Commons.messageEntity.get_requestLatLng();
...
//                Commons.requestLatlng=latLng;
    ...
    private  void showInfo() {
        ...
        if(Commons.messageEntity.get_photoUrl().length()>0) photo.setImageUrl(Commons.messageEntity.get_photoUrl(),_imageLoader);
        else if(Commons.thisEntity.get_photoUrl().length()>0)photo.setImageUrl(Commons.thisEntity.get_photoUrl(),_imageLoader);
        else photo.setDefaultImageResId(Commons.messageEntity.get_resId());
        final TextView textview = (TextView) dialogView.findViewById(R.id.customView);
        textview.setText(Commons.messageEntity.get_usermessage());
