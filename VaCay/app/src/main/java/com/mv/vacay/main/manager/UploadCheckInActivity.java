...
public class UploadCheckInActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_check_in);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.showInfo:
                ...
                break;
            case R.id.back:
                intent=new Intent(this,VendorUploadActivity.class);
                startActivity(intent);
                finish();
...
//        searchLocationOnAddress(Commons.gameEntityUpload.getBarName());
...
//            mMap.clear();
            ...
            Commons.gameEntityUpload.setKnownName(address);
...
//                    }
                    try{
                        if(Commons.gameEntityUpload.getKnownName().toLowerCase().trim().equals(user.get_publicName().toLowerCase().trim())) _datas.add(0,user);
