...
import com.mv.vacay.Sms;
import com.mv.vacay.adapter.AllConversationAdapter;
import com.mv.vacay.adapter.ItemCLickListener;
import com.mv.vacay.commons.Commons;
import com.mv.vacay.commons.Constants;
import com.mv.vacay.commons.SmsContract;
...
public class SendSMSActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onResume() {
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (new_sms)
                    getSupportLoaderManager().restartLoader(Constants.ALL_SMS_LOADER, null, SendSMSActivity.this);
    ...
    public void onBackPressed() {
        ...
        Commons._customer_booking=false;
        Commons._provider_booking=false;
