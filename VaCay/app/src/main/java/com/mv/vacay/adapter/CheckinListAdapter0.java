 ...
 */
public class CheckinListAdapter0 extends BaseAdapter {
    ...
    public CheckinListAdapter0(Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.checkin_people_item, parent, false);
