...
public class ProviderProductListActivity extends BaseActivity implements View.OnClickListener,SwipyRefreshLayout.OnRefreshListener {
    ListView listView;
    ImageView imvback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proid = intent.getStringExtra("proid");  Log.d("PROID===>",proid);
        company = intent.getStringExtra("company");   Log.d("Company===>",company);
...
//                JSONArray users = response.getJSONArray(ReqConst.RES_USERINFO);
                ...
                for (int i = 0; i < products.length(); i++) {
                    ...
                    productEntity.setProviderTakeHome(jsonBeauty.getString("providerTakeHome"));
                    productEntity.setManagerTakeHome(jsonBeauty.getString("managerTakeHome"));

                    productEntity.setLocation(address);
                    productEntity.setCompanyName(company);
