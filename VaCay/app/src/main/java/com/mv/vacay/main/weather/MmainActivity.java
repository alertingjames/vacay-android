...
import com.mv.vacay.adapter.ViewPagerAdapter;
import com.mv.vacay.adapter.WeatherRecyclerAdapter;
import com.mv.vacay.commons.Constants;
import com.mv.vacay.fragments.RecyclerViewFragment;
import com.mv.vacay.models.Weather;
import com.mv.vacay.tasks.GenericRequestTask;
import com.mv.vacay.tasks.ParseResult;
import com.mv.vacay.tasks.TaskOutput;
import com.mv.vacay.utils.UnitConvertor;
import com.mv.vacay.widgets.AbstractWidgetProvider;
import com.mv.vacay.widgets.DashClockWeatherExtension;
...
public class MmainActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(MmainActivity.this);
    ...
    public WeatherRecyclerAdapter getAdapter(int id) {
        ...
        if (id == 0) {
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(MmainActivity.this, longTermTodayWeather);
        } else if (id == 1) {
    ...
    protected void onDestroy() {
        ...
        if (locationManager != null) {
            try {
                locationManager.removeUpdates(MmainActivity.this);
    ...
    private void preloadWeather() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(MmainActivity.this);

        String lastToday = sp.getString("lastToday", "");
        if (!lastToday.isEmpty()) {
            new TodayWeatherTask(MmainActivity.this, this, progressDialog).execute("cachedResponse", lastToday);
        }
    ...
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MmainActivity.this);
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(MmainActivity.this).edit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_map) {
            Intent intent = new Intent(MmainActivity.this, MapActivity.class);
            startActivity(intent);
        }
        if (id == R.id.action_graphs) {
            Intent intent = new Intent(MmainActivity.this, GraphActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(MmainActivity.this, SettingsActivity.class);
            startActivity(intent);
        }
    ...
    class TodayWeatherTask extends GenericRequestTask {
        public TodayWeatherTask(Context context, MmainActivity activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(MmainActivity.this);
            DashClockWeatherExtension.updateDashClock(MmainActivity.this);
        }
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, MmainActivity activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, MmainActivity activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
